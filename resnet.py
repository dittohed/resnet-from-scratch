...
class Block(nn.Module):
    """
    Defines convX_x row from ResNet paper (Table 1).
    """

    def __init__(self, in_channels, out_channels, identity_downsample=None, stride=1):
        """
        in_channels - num. of block input channels
        out_channels - num. of block output channels before expansion
        """

        super(Block, self).__init__()
        self.expansion = 4  # Num. channels increase within block   
